...
const EditClient = ({ editClient, clientList, setClientList, setEditClient, isMobile }) => {
  ...
  return (
    <main className="flex flex-col justify-center items-center p-4 h-[90vh] md:h-full bg-gray-100 rounded-md w-full md:w-1/2">
      <h2 className="text-black text-left w-full my-2 font-bold text-xl">Editar clientes</h2>
      <form onSubmit={handleEditSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full overflow-y-auto h-[90vh] md:h-full">
        <div className="flex flex-col">
          <label className="text-sm font-semibold mb-1 text-black">Nome</label>
          <input
            type="text"
            name="name"
        ...
        <div className="flex flex-col">
          <label className="text-sm font-semibold mb-1 text-black">Telefone</label>
          <input
            type="text"
            name="phone"
        ...
        <div className="flex flex-col md:col-span-2">
          <label className="text-sm font-semibold mb-1 text-black">Observação</label>
          <textarea
            name="observation"
        ...
        {editClient.address && (
          <>
            <div className="flex flex-col">
              <label className="text-sm font-semibold mb-1 text-black">Rua</label>
              <input
                type="text"
                name="street"
            ...
            <div className="flex flex-col">
              <label className="text-sm font-semibold mb-1 text-black">Nº</label>
              <input
                type="text"
                name="number"
            ...
            <div className="flex flex-col">
              <label className="text-sm font-semibold mb-1 text-black">Bairro</label>
              <input
                type="text"
                name="neighborhood"
            ...
            <div className="flex flex-col">
              <label className="text-sm font-semibold mb-1 text-black">Complemento</label>
              <input
                type="text"
                name="complement"
            ...
            <div className="flex flex-col">
              <label className="text-sm font-semibold mb-1 text-black">Cidade</label>
              <input
                type="text"
                name="city"
            ...
            <div className="flex flex-col">
              <label className="text-sm font-semibold mb-1 text-black">Estado</label>
              <input
                type="text"
                name="state"
